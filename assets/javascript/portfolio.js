...
writeLine(["> Granting access to <span style='font-size: 14px; color: #ff91a4;'>[harmless.gg]</span>....", `> Access granted! <span style='font-size: 14px; color: #ff91a4;'>[completed]</span>`], 45, () => {
